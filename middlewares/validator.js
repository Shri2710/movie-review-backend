...
exports.validatePassword=check("password").not().isEmpty().withMessage("Passsword is missing").isLength({min:8,max:20}).withMessage("Password should be between 8 to 20 characters");
...
exports.isValidPassResetToken= async (req,res,next)=>{
    ...
    if(!token.trim() || !userId.trim()) return sendError(res,"Invalid Request!")
